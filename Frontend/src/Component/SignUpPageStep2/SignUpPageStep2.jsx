...
const SignUpPageStep2 = ({ setUser }) => {
    ...
    return (
        <div className='signup-container'>
            <div class="card Card my-4 rounded-3 shadow-sm">
                            ...
                            {formData.userType === 'student' && (
                                <>
                                    <div class="col-12">
                                        ...
                                        <input type="text" class="form-control" id="school" name='school' value={formData.school} onChange={handleChange} />
                                    </div>
                                    <div class="col-md-4">
                                        <label for="major" class="form-label">Major:</label>
                                        <select class="form-select" id="major" name='major' value={formData.major} onChange={handleChange} required="">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select class="form-select" id="gpa" name='gpa' value={formData.gpa} onChange={handleChange}>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select class="form-select" id="gender" name='gender' value={formData.gender} onChange={handleChange}>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <select class="form-select" id="raceEthnicity" name='raceEthnicity' value={formData.raceEthnicity} onChange={handleChange}>
                                    ...
                                    <div class="btn-group col-md-3 col-sm-12">
                                        <button class="btn text-truncate btn-secondary text-dark dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    ...
                                    <div class="btn-group col-md-3 col-sm-12">
                                        <button class="btn btn-secondary text-truncate text-dark dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    ...
                                    <div class="btn-group col-md-3 col-sm-12">
                                        <button class="btn btn-secondary text-dark dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                            Databases
                                        </button>
                                        <ul className="dropdown-menu">
